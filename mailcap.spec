...
%description -l pl
Plik mailcap jest u¿ywany przez program metamail i inne. Pakiet ten pozwoli
na automatyczne wy¶wietlanie grafiki przez programy takie jak lynx, przy
u¿yciu zgv.

%description -l de
Wenn es installiert ist, können Programme wie 'lynx' automatically 'zgv' zum
Darstellen von Bildern verwenden (zgv muß installiert sein).

%description -l fr
L'installer permettra à des programmes come lynx d'utiliser automatiquement
zgv pour afficher des images (pourvu que zgv soit installé).
...
install mailcap mailcap.vga mime.types $RPM_BUILD_ROOT/etc
